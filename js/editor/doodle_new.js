(function(Daisy, $) {
	...
	Daisy._Doodle = function(type, points, color, pen_width, eraser_list) {
		this.__id__ = Daisy._Doodle.__auto_id__++;
		this.points = points;
		this.color = color;
	...
	Daisy._Doodle.prototype = {
		...
		addEraserIfIn : function(eraser) {
			if(this._isEraserIn(eraser.points) && this.eraser_list.indexOf(eraser)<0) {
				this.eraser_list.push(new Daisy._Doodle.create(Daisy._Doodle.Type.ERASER, eraser.pen_width, "", [], eraser._copyPoints()));
			}
		},
